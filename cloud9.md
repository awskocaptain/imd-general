...
이 Lab에서는 EC2 Computing, VPC Network, Storage, DataBase 구성등에 대한 Hands On Lab을 구성합니다.

일부 고객사의 환경의 경우 Putty 또는 Terminal 접속이 제한 될 수 있습니다. AWS의 관리형 Cloud IDE 콘솔 Cloud9을 구성하여 랩에서 사용되는 환경을 시험해 볼 수 있습니다.

Lab 을 사용하는 환경에서 , Putty와 같은 터미널을 사용할 수 있는 환경이라면 이 단계를 생략해도 됩니다.
