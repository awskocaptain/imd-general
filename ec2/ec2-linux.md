...
* 스냅샷 볼륨을 테스트 하기 위해 " PUBLIC-02" EC2 인스턴스에 "iotop" 패키지를 설치합니다. 이미 스냅샷을 완료했기 때문에 "iotop"는 스냅샷에 반영되지 않았습니다.

```text
yum list installed | grep "iotop"
sudo yum -y install iotop
yum list installed | grep "iotop"
```

* 설치가 완료되면 아래와 같이 볼륨에 새로운 패키지가 설치된 것을 확인 할 수 있습니다.

![](../.gitbook/assets/image%20%2836%29.png)

* 이제 "PUBLIC-02" 인스턴스에서 기존 볼륨을 제거하고, 스냅샷 볼륨 원본을 "PUBLIC-02" 인스턴스에 연결합니다. "PUBLIC-02" 인스턴스를 중지합니다.

![](../.gitbook/assets/image%20%2882%29.png)

* EC2 대쉬보드에서 "ELASTIC BLOCK STORE" - "볼륨"을 선택합니다. 상단 메뉴 "작업"-"볼륨분리"를 선택합니다.

![](../.gitbook/assets/image%20%289%29.png)

![](../.gitbook/assets/image%20%2830%29.png)

* EC2 대쉬보드에서 **"ELASTIC BLOCK STORE" - "볼륨"**을 선택합니다. 상단 메뉴 **"작업"-"볼륨연결"**를 선택합니다. Stop되어 있는 **"PUBLIC-02" 인스턴스 ID**를 선택합니다. 디바이스는 **기존에 루트 디바이스 이름**을 입력합니다. **\(dev/xvda\)**
